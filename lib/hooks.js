...
exports.useRepeatMode = function () {
    var _a = react_1.useState(index_1.RepeatMode.None), repeatMode = _a[0], setRepeatMode = _a[1];
    react_1.useEffect(function () {
        function updateRepeatMode() {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, index_1.default.getRepeatMode()];
                        case 1:
                            repeatMode = _a.sent();
        ...
        updateRepeatMode();
        var sub = index_1.default.addEventListener(index_1.Event.RepeatModeChanged, function (data) {
...
function useProgress(updateInterval) {
    ...
    react_1.useEffect(function () {
        if (playerState === index_1.State.Stopped || playerState === index_1.State.None || playerState === index_1.State.Connecting) {
            setState({ position: 0, duration: 0, buffered: 0 });
            return;
        }
        //if (playerState !== State.Playing && playerState !== State.Buffering && playerState !== State.Ready) return
