...
function skipToPrevious(rewindWhenPositionLteSeconds) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, TrackPlayer.skipToPrevious(rewindWhenPositionLteSeconds || 0)];
        });
    });
}
...
function seekTo(position, toleranceBefore, toleranceAfter) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, TrackPlayer.seekTo(position, toleranceBefore, toleranceAfter)];
        });
    });
}
...
function setRepeatMode(repeat) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, TrackPlayer.setRepeatMode(repeat)];
        });
    });
}
function setPlayWhenReady(pwr) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, TrackPlayer.setPlayWhenReady(pwr)];
        });
    });
}
// MARK: - Getters
...
function getPlayWhenReady() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, TrackPlayer.getPlayWhenReady()];
        });
    });
}
