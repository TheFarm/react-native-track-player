import { MetadataOptions, PlayerOptions, Event, Track, State, RepeatMode, TrackMetadata, NowPlayingMetadata } from './interfaces';
...
declare function setPlayWhenReady(pwr: boolean): Promise<void>;
...
declare function getPlayWhenReady(): Promise<boolean>;
export * from './hooks';
...
declare const _default: {
    ...
    getPlayWhenReady: typeof getPlayWhenReady;
};
